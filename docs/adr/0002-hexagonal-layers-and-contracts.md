...
**Considered options:** packages de domínio compartilhados com o web; camadas só no API + contracts; BFF sem package de contrato; regras de mutabilidade no domain vs application.
